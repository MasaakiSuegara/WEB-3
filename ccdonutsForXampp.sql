...
(2, 'チョコレートデライト（5個入り）', 1600, '当当店の人気商品「チョコレートデライト」は、濃厚なチョコレートコーティングが魅力の贅沢なドーナツです。丁寧に揚げた生地に、なめらかでコクのあるチョコレートをたっぷりとコーティングし、見た目にも美しく仕上げました。一口食べれば、ふんわりとした生地の食感とチョコレートの深い甘みが口いっぱいに広がり、満足感のある味わいをお楽しみいただけます。', 0),
